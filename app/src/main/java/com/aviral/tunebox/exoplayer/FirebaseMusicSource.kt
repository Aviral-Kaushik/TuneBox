...
import com.aviral.tunebox.data.remote.MusicDatabase
import com.aviral.tunebox.exoplayer.State.*
...
class FirebaseMusicSource constructor(private val musicDatabase: MusicDatabase) {
